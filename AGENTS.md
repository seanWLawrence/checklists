...
- Prefer using `Codec` for runtime types and validation logic
- Prefer using `Either` for synchronous functions that can fail. And `EitherAsync` for asynchronous functions that can fail.
